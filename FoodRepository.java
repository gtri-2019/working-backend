...
class FoodRepository {
    ...
    FoodRepository() {
        ...
        Food coke = new Food("Coca-Cola", cokeNutritionFacts, cokeTags, R.drawable.waterfull);
        ...
        Food drpepper = new Food( "Dr Pepper", drpepperNutritionFacts, drpepperTags, R.drawable.waterfull);
        ...
        Food cfaSandwich = new Food( "Chick Fil A Chicken Sandwich", cfaSandwichNutritionFacts, cfaSandwichTags, R.drawable.waterfull);
        ...
        Food bigMac = new Food( "McDonalds Big Mac", bigMacNutritionFacts, bigMacTags, R.drawable.waterfull);
        ...
        Food waffle = new Food( "IHOP Belgian Waffle", waffleNutritionFacts, waffleTags, R.drawable.waterfull);
        ...
        Food laysClassic = new Food( "Lay's Classic Potato Chips", laysClassicNutritionFacts, laysClassicTags, R.drawable.waterfull);
        ...
        Food pjPizza = new Food( "Papa John's Medium Pepperoni Pizza (One Slice)", pjPizzaNutritionFacts, pjPizzaTags, R.drawable.waterfull);
        ...
        Food spaghettiMeatballs = new Food( "Macaroni Grill Spaghetti and Meatballs", spaghettiMeatballsNutritionFacts, spaghettiMeatballsTags, R.drawable.waterfull);
        ...
        Food mdFrenchFries = new Food( "Small McDonalds French Fries", mdFrenchFriesNutritionFacts, mdFrenchFriesTags, R.drawable.waterfull);
        ...
        Food peOrangeChicken = new Food( "Panda Express Orange Chicken", peOrangeChickenNutritionFacts, peOrangeChickenTags, R.drawable.waterfull);
